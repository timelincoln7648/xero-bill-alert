...
describe('/banktransactions', function () {
    ...
    it('can get all', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, xero.bankTransactions.get()];
                case 1:
                    response = _a.sent();
    ...
    it('can get single', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, xero.bankTransactions.get({ BankTransactionID: existingId })];
                case 1:
                    newResponse = _a.sent();
    ...
    it('can update', function () { return __awaiter(_this, void 0, void 0, function () {
        var deleteResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, xero.bankTransactions.update({
