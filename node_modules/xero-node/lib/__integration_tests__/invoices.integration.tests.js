...
describe('/invoices', function () {
    ...
    it('create multiple', function () { return __awaiter(_this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('get single', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, entityId_helpers_1.getOrCreateInvoiceId(xero)];
                case 1:
                    invoiceId = _a.sent();
                    return [4 /*yield*/, xero.invoices.get({ InvoiceID: invoiceId })];
                case 2:
                    response = _a.sent();
                    expect(response).toBeDefined();
                    expect(response.Id).toBeTruthy();
    ...
    it('get single as pdf', function () { return __awaiter(_this, void 0, void 0, function () {
        var response, _a, _b, _c, invoiceBuffer;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _b = (_a = xero.invoices).savePDF;
                    _c = {};
                    return [4 /*yield*/, entityId_helpers_1.getOrCreateInvoiceId(xero)];
                case 1: return [4 /*yield*/, _b.apply(_a, [(_c.InvoiceID = _d.sent(), _c.savePath = tmpDownloadFile, _c)])];
                case 2:
                    response = _d.sent();
    ...
    function collectInvoicesToArchive(response) {
        invoiceIdsToArchive = invoiceIdsToArchive.concat(response.Invoices.map(function (invoice) { return invoice.InvoiceID; }));
    }
});
