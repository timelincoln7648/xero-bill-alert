...
function readLine(stringPrompt) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    prompt.start();
                    prompt.get([stringPrompt], function (err, result) {
...
exports.getPrivateConfig = getPrivateConfig;
function getLoginConfig() {
    if (!process.env.CI) {
        var config = require('../xero-login.json');
        return config;
    }
    else {
        return {
...
function getPartnerAppConfig() {
    if (!process.env.CI) {
        var config = require('../partner-config.json');
        return config;
    }
    else {
        return {
...
exports.getPartnerAppConfig = getPartnerAppConfig;
function setJestTimeout() {
    if (jest) {
        jest.setTimeout(60000);
    }
}
exports.setJestTimeout = setJestTimeout;
