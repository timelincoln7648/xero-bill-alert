...
describe('/banktransfers', function () {
    ...
    it('can get all', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, xero.bankTransfers.get()];
                case 1:
                    response = _a.sent();
    ...
    it('can get single', function () { return __awaiter(_this, void 0, void 0, function () {
        var bankTransferId, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, entityId_helpers_1.getOrCreateBankTransferId(xero)];
                case 1:
                    bankTransferId = _a.sent();
                    return [4 /*yield*/, xero.bankTransfers.get({ BankTransferID: bankTransferId })];
                case 2:
                    response = _a.sent();
    ...
    it('create', function () { return __awaiter(_this, void 0, void 0, function () {
        var fromAccountId, toAccountId, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, entityId_helpers_1.getOrCreateAccountId(xero, { where: 'Type=="BANK"' })];
                case 1:
                    fromAccountId = _a.sent();
                    return [4 /*yield*/, entityId_helpers_1.getOrCreateAccountId(xero, { where: "Type==\"BANK\"&&AccountID!=GUID(\"" + fromAccountId + "\")" })];
                case 2:
                    toAccountId = _a.sent();
