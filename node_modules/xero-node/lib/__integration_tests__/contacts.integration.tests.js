...
describe('/contacts', function () {
    ...
    it('create contacts', function () { return __awaiter(_this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, xero.contacts.create({
                        Contacts: [{
    ...
    it('gets a contact by ID', function () { return __awaiter(_this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, xero.contacts.get({ ContactID: contactIdsToArchive[0] })];
                case 1:
                    response = _a.sent();
    ...
    afterAll(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    contactsToUpdate = contactIdsToArchive.map(function (contactId) { return ({
                        ContactID: contactId,
                        Status: 'ARCHIVED'
                    }); });
                    return [4 /*yield*/, xero.contacts.update({
    ...
    function collectContactsToArchive(response) {
        contactIdsToArchive = contactIdsToArchive.concat(response.Contacts.map(function (contact) { return contact.ContactID; }));
    }
});
