...
describe.skip('Partner Example Tests with callbackUrl', function () {
    ...
    beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
        var browser, pageUrl, querystrings;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 13:
                    _a.sent();
                    pageUrl = page.url();
                    querystrings = querystring.parse(pageUrl);
                    oauth_verifier = querystrings.oauth_verifier;
                    browser.close();
                    return [2 /*return*/];
            }
        });
    }); });
    describe('Partner Example Tests with callbackUrl', function () { return __awaiter(_this, void 0, void 0, function () {
        var _this = this;
        return __generator(this, function (_a) {
            ...
            describe('OAuth State', function () {
                ...
                it('it lets you make API calls using the restored state', function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, accounting2_callback.organisation.get()];
                            case 1:
                                inv3 = _a.sent();
